  ...
  <div className="container">
    ...
    <div className="row mb-5 align-items-center">
      ...
      <div className="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="{200}">
        <h2 className="text-black mb-4">Gói free</h2>
        ...
        <div className="d-flex align-items-center custom-icon-wrap mb-3">
          <span className="custom-icon-inner mr-3"><span className="icon icon-graduation-cap" />
            <div><h3 className="ml-5">22,931 Yearly Graduates</h3></div>
          </span></div>
        <div className="d-flex align-items-center custom-icon-wrap mt-5">
          <span className="custom-icon-inner mr-3"><span className="icon icon-university" />
            <div><h3 className="ml-5">150 Universities Worldwide</h3></div>
          </span></div>
      </div>
    </div>
    <div className="row mb-5 align-items-center">
      ...
      <div className="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="{200}">
        <h2 className="text-black mb-4">Gói Gold</h2>
        <p className="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem maxime nam porro possimus fugiat quo molestiae illo.</p>
        <div className="d-flex align-items-center custom-icon-wrap mb-3">
          <span className="custom-icon-inner mr-3"><span className="icon icon-graduation-cap" />
            <div><h3 className="ml-5">22,931 Yearly Graduates</h3></div>
    ...
    <div className="row mb-5 align-items-center">
      ...
      <div className="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="{200}">
        <h2 className="text-black mb-4">Gói Platinum</h2>
        <p className="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem maxime nam porro possimus fugiat quo molestiae illo.</p>
        <div className="d-flex align-items-center custom-icon-wrap mb-3">
          <span className="custom-icon-inner mr-3"><span className="icon icon-graduation-cap" />
            <div><h3 className="ml-5">22,931 Yearly Graduates</h3></div>
